...
function tie_add_admin() {
	...
	add_menu_page(theme_name.' 设置', theme_name ,'switch_themes', 'panel' , 'panel_options', $icon  );
	...
	add_submenu_page('panel',theme_name.' 参考资料', '参考资料','switch_themes', 'docs' , 'redirect_docs');
